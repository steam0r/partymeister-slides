...
export default class Bonzo {
    ...
    bonzoInit(element, source, images) {
    ...
    async setUpScene() {
        const div = document.getElementById("shader-container");

        // fetch stuff
        const psource = fetch("/bonzojs_200408_01/data/shader.glsl");
        const picons = loadImageAsync("/bonzojs_200408_01/data/icons.png");
        const plogo = loadImageAsync("/bonzojs_200408_01/data/logo.png");
        ...
        this.bonzoRender = this.bonzoInit(div, source, textures);
    }
    ...
    animate(timestamp) {
        ...
        this.bonzoRender(timestamp, uniforms);
