...
class SlideClientGrid extends Grid
{
    ...
    protected function setup()
    {
        ...
        $this->addColumn('type', trans('partymeister-slides::backend/slide_clients.type'))->renderer(TranslateRenderer::class, ['file' => 'partymeister-slides::backend/slide_clients.types']);
        ...
        $this->addAction(trans('partymeister-slides::backend/slide_clients.open_client'), 'backend.slidemeister-web.show', ['class' => 'btn-primary'])->onCondition('type', 'slidemeister-web', '=');
