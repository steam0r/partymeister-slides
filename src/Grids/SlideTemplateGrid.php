...
class SlideTemplateGrid extends Grid
{
    ...
    protected function setup()
    {
        ...
        $this->addColumn('template_for', trans('partymeister-slides::backend/slide_templates.template_for'))->renderer(TranslateRenderer::class, ['file' => 'partymeister-slides::backend/slide_templates.template_for_types']);
        ...
        $this->addDuplicateAction(trans('motor-backend::backend/global.duplicate'), 'backend.slide_templates.duplicate')->needsPermissionTo('slide_templates.write');
